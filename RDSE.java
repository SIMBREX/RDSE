 ...
 *
 * VERSION - 1.0
 * HOW TO USE - https://github.com/SIMBREX/RDSE
...
class RDSE {
    ...
    private byte[] _encrypt(byte[] data, byte[] key, int depth){
        ...
        key = twinSort(numberGenerator.generateNumbersArray(keySign1, key.length, key.length), key);
